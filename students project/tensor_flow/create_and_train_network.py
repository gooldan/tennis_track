...
flags.DEFINE_string('train_dir', 'checkpoints', 'Directory to put the training data.')
...
def run_training():
  ...
  with tf.Graph().as_default():
    ...
    with gfile.FastGFile('output_graph.pb', 'w') as f:
      f.write(str(sess.graph_def))
    with gfile.FastGFile('output_labels.txt', 'w') as f:
      f.write('ball' + '\n')
      f.write('not ball')
